...
let xlen = x.toString().length - x.toString().length.indexOf(".")-1;
let ylen = y.toString().length - y.toString().length.indexOf(".")-1;


}

function splitFunc(x,y){
    len1 = getlen(x);
    len2 = getlen(y);
    // 소숫점 자릿수 알아오는 함수 실행
...
console.log(splitFunc(0.435214 , 0.1));